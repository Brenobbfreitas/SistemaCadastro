🚀 Sistema Next.js + Prisma (Docker Estável)
...
Para suporte ou dúvidas, entre em contato com Person. Um documento detalhado com os logs de erros pode ser encontrado em File.
